...
from pages.ebaysdk import set_stream_logger, UserAgent
from pages.ebaysdk.utils import getNodeText as getNodeTextUtils, smart_encode, smart_decode
from pages.ebaysdk.utils import getValue, smart_encode_request_data
from pages.ebaysdk.response import Response
from pages.ebaysdk.exception import ConnectionError, ConnectionResponseError
...
class BaseConnection(object):
    ...
    def response_soup(self, BeautifulSoup=None):
